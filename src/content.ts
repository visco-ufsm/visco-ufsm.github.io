...
export const PROJECTS: Project[] = [
  ...
  {
    title: "Neural Network Decomposition and Energy Efficiency",
    year: "2024–27",
    desc: "Application of multilinear algebra and tensor decomposition techniques, particularly HOSVD, to neural network compression, reducing computational complexity and energy consumption. The project combines tensor decomposition with AutoML to develop efficient models without requiring specialized hardware.",
    lines: ["ci"],
  ...
  }, 
  {
    ...
    lines: ["ci"],
    tags: ["L. Schirmer", "CENPES/Petrobras"],
    active: true,
    code: null,
  },
];
...
export const PUBS: Pub[] = [
  ...
  },
  {
    ...
    venue: "SBC/SBMicro/IEEE Symposium on Integrated Circuits and Systems Design",
    type: "Conference",
    lines: ["sr", "gvc"],
    accepted: true,
    pdf: null,
  ...
  },
  {
    ...
    lines: ["sr", "sip"],
    pdf: null,
    doi: "https://doi.org/10.1109/ACCESS.2026.3680290",
    code: null,
  },
    {
    year: 2025,
  ...
  },
  {
    ...
    lines: ["ci", "vu", "sip"],
    pdf: null,
    doi: "https://doi.org/10.1109/IGARSS55030.2025.11243698",
    code: null,
  },
  {
    year: 2025,
    title: "Analytical propagation of errors and uncertainties in deep neural networks in the domain of physical sciences",
    authors: "de Mello, G. E., Nardelli, V. C., Righi, R. da R., Schirmer, L., and Ramos, G. de O.",
    venue: "Engineering Applications of Artificial Intelligence",
    type: "Journal",
    lines: ["ci"],
    pdf: null,
    doi: "https://doi.org/10.1016/j.engappai.2025.110682",
    code: null,
  },
  {
    year: 2025,
  ...
  },
  {
    ...
    authors: "Cruz, A., Schardong, G., Schirmer, L., Marcos, J., Shadmand, F., and Gonçalves, N.",
    venue: "IEEE/CVF Winter Conference on Applications of Computer Vision",
    type: "Conference",
    lines: ["sr", "ci", "vu"],
    pdf: null,
    doi: "https://doi.org/10.1109/WACV61041.2025.00736",
    code: null,
  },
  {
    year: 2025,
    title: "StylePuncher: Encoding a Hidden QR Code into Images",
    authors: "Shadmand, F., Schirmer, L., and Gonçalves, N.",
    venue: "International Conference on Pattern Recognition Applications and Methods",
    type: "Conference",
    lines: ["sr", "ci", "vu"],
    pdf: null,
    doi: "https://doi.org/10.5220/0013190800003905",
    code: null,
  },
];
...
export const NEWS: NewsItem[] = [
  ...
  },*/
  {
    ...
    img: "/news/D676EF4B-4F25-4139-8481-5E67D8D22E36.png",
    href: "publications",
  },
  {
    date: "Sep 2026",
